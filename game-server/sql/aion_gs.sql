...
-- ----------------------------
-- Table structure for `ai_companions`
-- ----------------------------
DROP TABLE IF EXISTS `ai_companion_goals`;
DROP TABLE IF EXISTS `ai_companions`;
DROP TABLE IF EXISTS `ai_companion_creation_claims`;
CREATE TABLE `ai_companion_creation_claims` (
...
-- ----------------------------
-- Table structure for `ai_companion_goals`
-- ----------------------------
CREATE TABLE `ai_companion_goals` (
  `owner_player_id` int NOT NULL,
