...
Статус: baseline architecture audit этапа 0
...
> Это исторический baseline-аудит от 2026-07-30, а не описание текущего
> состояния. Принятые slices и актуальный статус находятся в
> [`PROJECT_STATE.md`](PROJECT_STATE.md); последующие решения — в ADR-0001…0006.
